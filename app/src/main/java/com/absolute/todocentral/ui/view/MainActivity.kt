...
class MainActivity : BaseActivity() {
    ...
    private val babMainMenu: BottomAppBar by bindView(R.id.babMainMenu)
    private val llEmptyView: LinearLayout by bindView(R.id.llEmptyView)
    private val empty_list: LottieAnimationView by bindView(R.id.empty_list)
    ...
    private fun initListeners() {
        ...
        mRecyclerView.addOnScrollListener(object : RecyclerViewScrollListener() {
            ...
            override fun onToolbarHide() = animateToolbar(-(toolbar?.height?.toFloat() ?: 0f), AccelerateInterpolator(2F))
